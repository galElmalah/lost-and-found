    ...
    <form className={style.form} noValidate autoComplete="off">
      ...
      <div className={style.btns}>
        <Button onClick={async () => {
          if (name && description) {
            const lostOrFoundAt = selectedDate;
            await addMarker({ name, description, entryType, location: useCurrentLocation ? initialPosition : draggableMarkerPosition, lostOrFoundAt })
